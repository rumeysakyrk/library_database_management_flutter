...
class _ChangeStatusState extends State<ChangeStatus> {
  ...
  Future<dynamic> generateBookList() async {
    ...
    var url = Uri.parse('http://127.0.0.1/login/book.php');
    final response =
        await http.get(Uri.parse('http://127.0.0.1/login/book.php'));
...
class _StatusChangePlaceState extends State<StatusChangePlace> {
  Future giveBook() async {
    ...
    final response = await http
        .post(Uri.parse("http://127.0.0.1/login/changestatus.php"), body: {
